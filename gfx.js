(function() {
  ...
  gfx.Rectangle.prototype.bounceSprite = function(vector, rectangle) {
    ...
    if (firstRectangleRight >= secondRectangleLeft && firstRectangleBottom >= secondRectangleTop) {
      ...
      if (firstRectangleRight === secondRectangleLeft || firstRectangleLeft === secondRectangleRight) {
        vector.x *= -1;
      }
      else {
        vector.y *= -1;
  ...
  gfx.Sprite.prototype.correctVectorAndPositionIfNeeded = function(spriteMap, rectangles, canvas) {
    ...
    for (var i = 0; i < rectangles.length; ++i) {
      //spriteRectangle.bounceSprite(this._vector, rectangles[i]);
  ...
  gfx.Sprite.prototype.bounceSprite = function(sprite) {
    ...
    var secondSpriteRight = secondSpriteX._position.x + secondSpriteX._size.width;

    var firstSpriteBottom = firstSpriteY._position.y + firstSpriteY._size.height;
    var secondSpriteTop = secondSpriteY._position.y;
    var firstSpriteLeft = firstSpriteX._position.x;
    var secondSpriteLeft = secondSpriteX._position.x;

    if (firstSpriteRight >= secondSpriteLeft && firstSpriteBottom >= secondSpriteTop) {

      if (firstSpriteRight === secondSpriteLeft || firstSpriteLeft === secondSpriteRight) {
        this.vector.x *= -1;
        sprite.vector.x *= -1;
      }
      else {
